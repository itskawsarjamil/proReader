...
import animation from "../assets/animationfromlottiefiles.json"
export const Home = () => {
    return (
                ...
                <div className="flex flex-col items-center justify-between lg:flex-row">
                    <div className="mb-10 lg:max-w-lg lg:pr-5 lg:mb-0">
                        <div className="max-w-xl mb-6 text-start">
                            <div className="">
                                <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-black uppercase rounded-full bg-yellow-500 ">
                                    ON SALE
                                </p>
                            </div>
